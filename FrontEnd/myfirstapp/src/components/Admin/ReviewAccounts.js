...
class ReviewAccounts extends Component {
    ...
    componentDidMount() {
        fetch("hhttp://adminmicroservice-env.eba-jebjkeyt.ap-southeast-2.elasticbeanstalk.com/api/admin/allusers").then((response) => response.json()).then(result => { this.setState({ allActiveUsers: result }) });
